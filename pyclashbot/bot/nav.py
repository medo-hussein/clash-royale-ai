...
def check_if_on_clash_main_menu(emulator) -> bool:
    ...
    # google play colors
# التحديث الجديد بناءً على ألوان الأبديت اللي البوت شايفها
    colors_1 = [
        [58, 148, 208],  # القيمة الجديدة 1
        [22, 146, 43],   # القيمة الجديدة 2
        [38, 18, 3],     # القيمة الجديدة 3
        [232, 192, 124], # القيمة الجديدة 4
        [138, 105, 71],  # القيمة الجديدة 5
        [139, 106, 72],  # القيمة الجديدة 6
        [155, 120, 82],  # القيمة الجديدة 7
    ]
